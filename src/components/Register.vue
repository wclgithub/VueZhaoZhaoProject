    ...
    <div class="login-background">
      <div id="login">
        ...
        <form action="" id="loginform">
          <div>
            <input type="text" required placeholder=" 请输入您的手机号码" id="reg-tel" name="tel" v-model="reg_tel">
            <div class="tel-reg-err"></div>
            <!--value="15776554504"-->
            <input type="password" required placeholder=" 请输入您的密码" id="reg-pwd" name="reg-password" v-model="reg_pwd">

            <input type="password" required placeholder=" 请再次输入您的密码" id="conf-pwd" name="conf-password" v-model="reg_conpwd">
            <!--value="175436"-->
  ...
  methods:{
    regist:function () {
      if (!this.reg_tel)
        ...
        if (this.reg_pwd && this.reg_pwd.length>=6){
